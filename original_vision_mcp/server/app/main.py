...
from .tasks import init_task_processor, task_processor
...
async def lifespan(app: FastAPI):
    ...
    # Load plugins
    plugins_dir = os.getenv("VISION_PLUGINS_DIR", "server/app/plugins")
    ...
    # Shutdown
    logger.info("Shutting down Vision MCP Server...")
...
app = FastAPI(
    ...
    description="Modular vision processing server for Gemini-CLI",
    version="0.1.0",
    lifespan=lifespan
)
            ...
            if data.get("type") == "frame":
                ...
                if new_plugin:
                    ...
                    await ws_manager.send_error(
                        client_id, 
                        f"Plugin '{new_plugin_name}' not found"
                    )
