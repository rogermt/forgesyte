...
class PluginManager:
    ...
    def _load_plugin_from_file(self, plugin_file: Path, module_name: str) -> Optional[PluginInterface]:
        """Load a single plugin from a file."""
        spec = importlib.util.spec_from_file_location(
            f"vision_plugins.{module_name}",
            plugin_file
        )
        ...
        if hasattr(module, "Plugin"):
            ...
            if isinstance(instance, PluginInterface):
                ...
                raise TypeError(f"Plugin class does not implement PluginInterface")
