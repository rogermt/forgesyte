...
-- Canonical governance specification for Phase 8 metrics database
-- Must be kept in sync with: server/app/observability/duckdb/schema.sql
-- Enforced by: scripts/ci/test_schema_drift.py
