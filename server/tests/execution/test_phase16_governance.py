...
class TestPhase16Governance:
    ...
    def test_no_forbidden_vocabulary_in_functional_code(self):
        ...
        assert not violations, (
            f"Forbidden vocabulary found in Phase 16 functional code:\n"
            + "\n".join(violations)
        )
    ...
    def test_governance_scanner_runs(self):
        ...
        """
        scanner_path = Path("/home/rogermt/forgesyte/server/tools/validate_phase16_path.py")
        
        # Verify scanner exists
        assert scanner_path.exists(), (
            f"Governance scanner not found at {scanner_path}"
        )
    ...
    def test_governance_config_exists(self):
        ...
        assert config_path.exists(), (
            f"Governance config not found at {config_path}"
        )
